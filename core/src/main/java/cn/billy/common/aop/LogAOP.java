package cn.billy.common.aop;

import cn.billy.common.annotations.Log;
import cn.billy.common.rbac.User;
import cn.billy.common.utils.SPELUtil;
...
public class LogAOP {
    ...
    @Pointcut("@annotation(cn.billy.common.annotations.Log)")
